                    ...
                    <div class="card-body">
                        <form action="{{ route('siswas.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama" style="width: 20rem" value="{{ old('nama') }}" placeholder="Masukkan Nama">
                            ...
                            <select name="kelas" class="form-select" style="width: 20rem" aria-label="Default select example">
